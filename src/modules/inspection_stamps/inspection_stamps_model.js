...
const InspectionStampsModel = {
    ...
    create: async (data) => {
        ...
        const query = `
            INSERT INTO public.inspection_stamps (bill_inputs_id, users_id, internal_diameter, external_diameter, height_a, height_b, review_date, delivery_date, observation, status)
    ...
    update: async (id, data) => {
        ...
        const query = `
            UPDATE public.inspection_stamps 
